...
const Star = () => {
    return (
        <svg className={styles.star} viewBox="0 0 160 160" width="18" height="18">  
        ...
        <path fill="#000" d="M72 19.3l13.6 35.4 37.9 2-29.5 23.9 9.8 36.6-31.8-20.6-31.8 20.6 9.8-36.6-29.5-23.9 37.9-2z"/>
      </svg>
    )
}
